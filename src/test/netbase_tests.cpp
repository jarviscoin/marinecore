...
{
    BOOST_CHECK(TestSplitHost("www.marineco.in", "www.marineco.in", -1));
    BOOST_CHECK(TestSplitHost("[www.marineco.in]", "www.marineco.in", -1));
    BOOST_CHECK(TestSplitHost("www.marineco.in:80", "www.marineco.in", 80));
    BOOST_CHECK(TestSplitHost("[www.marineco.in]:80", "www.marineco.in", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:54595", "127.0.0.1", 54595));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:54595", "127.0.0.1", 54595));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:54595", "::ffff:127.0.0.1", 54595));
    BOOST_CHECK(TestSplitHost("[::]:54595", "::", 54595));
    BOOST_CHECK(TestSplitHost("::54595", "::54595", -1));
    BOOST_CHECK(TestSplitHost(":54595", "", 54595));
    BOOST_CHECK(TestSplitHost("[]:54595", "", 54595));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:54595", "127.0.0.1:54595"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:54595", "[::]:54595"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
